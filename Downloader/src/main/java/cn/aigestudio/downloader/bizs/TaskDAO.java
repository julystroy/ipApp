...
import static cn.aigestudio.downloader.bizs.DLCons.DBCons.TB_TASK_STATE;
...
class TaskDAO implements ITaskDAO {
    ...
    public void updateTaskInfo(DLInfo info) {
        ...
        db.execSQL("UPDATE " + TB_TASK + " SET " +
                ...
                info.mimeType, info.totalBytes, info.fileName, info.currentBytes, info.state, info.baseUrl});
        db.close();
    }
