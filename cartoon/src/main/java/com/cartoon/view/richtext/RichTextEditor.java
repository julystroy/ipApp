package com.cartoon.view.richtext;
...
public class RichTextEditor extends ScrollView {
    private static final int EDIT_PADDING = 18; // edittext常规padding是10dp
    ...
    public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        allLayout.setPadding(30, 33, 50, 15);//设置间距，防止生成图片时文字太靠边，不能用margin，否则有黑边
        ...
        EditText firstEdit = createEditText("挥洒你的才华吧 ", dip2px(context, EDIT_PADDING));
