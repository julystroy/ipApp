...
public class MessagesListAdapter<MESSAGE extends Message>
     ...
     */
    public MessagesListAdapter(Activity context, String senderId, ImageLoader imageLoader) {
     ...
     * @param imageLoader image loading method.
     */
    public MessagesListAdapter(Activity context, String senderId, MessageHolders holders,
    ...
    * */
     ...
     */
    public void addToStart(MESSAGE message, final boolean scroll) {
    ...
    * */
    ...
    private boolean isPreviousSameAuthor(String id, int position) {
        ...
        else return items.get(prevPosition).item instanceof Message
                && ((MESSAGE) items.get(prevPosition).item).getUid().contentEquals(id);
    }
    ...
    * */
     ...
     */
    public interface OnMessageClickListener<MESSAGE extends Message> {
     ...
     */
    public interface OnMessageViewClickListener<MESSAGE extends Message> {
     ...
     */
    public interface OnMessageLongClickListener<MESSAGE extends Message> {
     ...
     */
    public interface OnMessageViewLongClickListener<MESSAGE extends Message> {
    ...
    public static class HoldersConfig extends MessageHolders {
         ...
         */
        @Deprecated
        public void setIncoming(Class<? extends BaseMessageViewHolder<? extends Message>> holder, @LayoutRes int layout) {
         ...
         */
        @Deprecated
        public void setIncomingHolder(Class<? extends BaseMessageViewHolder<? extends Message>> holder) {
         ...
         */
        @Deprecated
        public void setOutcoming(Class<? extends BaseMessageViewHolder<? extends Message>> holder, @LayoutRes int layout) {
         ...
         */
        @Deprecated
        public void setOutcomingHolder(Class<? extends BaseMessageViewHolder<? extends Message>> holder) {
     ...
     */
    @Deprecated
    public static abstract class BaseMessageViewHolder<MESSAGE extends Message>
     ...
     */
    @Deprecated
    public static class IncomingMessageViewHolder<MESSAGE extends Message>
     ...
     */
    @Deprecated
    public static class OutcomingMessageViewHolder<MESSAGE extends Message>
