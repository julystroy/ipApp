...
class MessageInputStyle extends Style {
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.attachmentButtonDefaultBgColor = typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultBgColor,
                style.getColor(R.color.color_white));
        ...
        style.attachmentButtonDefaultIconColor = typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconColor,
                style.getColor(R.color.md_material_blue_600));
        ...
        style.inputTextColor = typedArray.getColor(R.styleable.MessageInput_inputTextColor, style.getColor(R.color.black));
        style.inputHintColor = typedArray.getColor(R.styleable.MessageInput_inputHintColor, style.getColor(R.color.color_expound_item_desc));
...
//                    inputButtonDefaultBgDisabledColor, R.drawable.fang_background);
           return getVectorDrawable(R.mipmap.icon_send);
        } else {
...
//                    inputButtonDefaultIconDisabledColor, R.mipmap.icon_send);
           // return DrawableCompat.wrap(getVectorDrawable(R.mipmap.icon_send)).mutate();
            return getVectorDrawable(R.drawable.fang_background);
        } else {
