 ...
 */
    ...
    public class TextViewExpandableAnimation extends LinearLayout
        ...
        private void initValue(Context context, AttributeSet attrs) {
            ...
            textContentColor = ta.getColor(R.styleable.TextViewExpandableAnimation_tvea_textContentColor, ContextCompat.getColor(context, R.color.color_bg));
        ...
        private void initView(Context context) {
            ...
            textView.setLines(5);//控制进来时的行数
            textView.setTextColor(textContentColor);
            textView.setTextIsSelectable(true);
            textView.setLineSpacing(1.3f,1.3f);//设置行距
...
//            tvState.setOnClickListener(this);
        ...
        public void setText(CharSequence charSequence,int type) {
        ...
        private void doNotExpand() {
           // textView.setMaxLines(expandLines);
            rlToggleLayout.setVisibility(View.GONE);
           // textView.setOnClickListener(null);
            textView.setLines(textLines);//防止出现空白
        }
