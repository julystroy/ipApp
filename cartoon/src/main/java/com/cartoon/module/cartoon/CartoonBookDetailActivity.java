 ...
 */
public class CartoonBookDetailActivity extends BaseActivity implements View.OnClickListener, CartoonBookDetailAdapter.OnClickListener, EndLessListener {
...
//    ImageView ivShare;
    ...
    private CartoonBookDetailAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // boolean showKeyBoard = getIntent().getBooleanExtra(Keys.SHOW_KEYBOARD, false);
        ...
        tvTitle.setText("书评详情");
        btLeft.setImageResource(R.mipmap.icon_back_black);
        btRight.setVisibility(View.GONE);

        btLeft.setOnClickListener(this);
        sendBt.setOnClickListener(this);
        adapter = new CartoonBookDetailAdapter(CartoonBookDetailActivity.this,moment);
        ...
        switch (v.getId()) {
            ...
            case R.id.send_bt:
                ...
                if (TextUtils.isEmpty(message)) {
                    ToastUtils.showShort(CartoonBookDetailActivity.this, getString(R.string.pleaes_input_comment_context));
                    return;
                }
                if (comment!=null)
    ...
    private void sendCartonComment(String r_id, String message) {
        if (message.equals(lastComment)||comment==null) return;
        lastComment = message;
        showLoadingDialog();
        ...
        builder.build().execute(new BaseCallBack() {
            ...
            public void onLoadSuccess(Object response) {
                ...
                Utils.closeSoftKeyboard(etInput, CartoonBookDetailActivity.this);
                loadCommentDetail(START_PAGE);
    ...
    private void loadCommentDetail(final int pageNum) {
        BuilderInstance.getInstance()
            ...
            @Override
            public void onLoadFail() {
                Toast.makeText(CartoonBookDetailActivity.this , "内容不存在或已删除"  , Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(CartoonCommentChild child, int position) {
        if (!CartoonApp.getInstance().isLogin(CartoonBookDetailActivity.this)) return;
