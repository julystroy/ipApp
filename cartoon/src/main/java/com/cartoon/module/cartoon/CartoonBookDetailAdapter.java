...
public class CartoonBookDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CartoonBookDetailAdapter(Context context, BookFriendMoment moment ) {
    ...
    public void setData(CartoonComment comment) {
        ...
        this.totalPage = comment.getChildren().getTotalRow();
    ...
    public void addAll(CartoonComment.ChildrenBean list) {
        ...
        this.totalPage = list.getTotalRow();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.item_book_comment_detail, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        if (viewHolder instanceof HeadViewHolder) {
          ...
          //  webSettings.setLoadWithOverviewMode(true);
            ...
            if (moment==null)
                return;
            holder.mWebView.loadUrl(StaticField.HTML_BASE_URL + "/bookreview/getDetail?dataId="+moment.getId()+ "&userId="
                    +userId+"&toCmdUserId="+moment.getUid()+"&nickName="+moment.getNickname());
          ...
          //  holder.setIsRecyclable(false);//去除复用,不然自定义控件复用(加载评论较少,否则会慢)
                ...
                holder.tvSort.setText((totalPage-pos)+"楼");
    ...
    private void deleteComment(String comment_id, final ItemViewHolder holder, final int position) {
        ...
        BuilderInstance.getInstance()
            ...
            public void onLoadSuccess(Object response) {
                ...
                notifyDataSetChanged();
                Utils.closeSoftKeyboard(holder.tvDelete, (CartoonBookDetailActivity) context);
