 ...
 */
public class NewRankFragment extends BaseFragment implements EndLessListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
...
//    TextView            mTvRankNum;
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        adapter = new ActionRankAdapter(getContext(),"new");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_join:
                ...
                break;
            case R.id.bt_show:  // FIXME: 17-8-30 跳转到详情所需要的参数
