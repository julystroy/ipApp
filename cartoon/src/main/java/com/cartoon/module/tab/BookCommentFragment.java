...
import com.cartoon.module.tab.bookfriendmoment.BookCommentPresentImp;
import com.cartoon.module.tab.bookfriendmoment.BookFriendMomentAdapter;
import com.cartoon.module.tab.bookfriendmoment.BookFriendMomentPresenter;
import com.cartoon.module.tab.bookfriendmoment.BookFriendMomentView;
import com.cartoon.module.tab.bookfriendmoment.PreviewPhotoActivity;
import com.cartoon.utils.BangaiReadedUtil;
 ...
 */
public class BookCommentFragment extends BaseFragment implements BookFriendMomentView,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     //   EventBus.getDefault().register(this);
        ...
        presenter = new BookCommentPresentImp(this);
...
//                 Type:活动=0 漫画=1 听书=2 嘻说=3 (动态 书友圈=4 评论=5) 追听=6 Q漫=7 番外=8 静态电影=9
...
//                    Intent intent = new Intent(getContext(), ListenerDetailActivity.class);
...
//                    startActivity(intent);
                    ...
                    startActivity(intent);
                } else if (momentType == 7||  momentType ==9||momentType==0) {
